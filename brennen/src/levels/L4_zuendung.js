    ...
    const phaseFragen = () => {
      const fragen = [
        ...
        },
        {
          ...
          antworten: [
            'Die Temperatur, ab der sie von selbst brennt',
            'Die Temperatur, ab der ihre Dämpfe zünden',
            'Die Temperatur ihrer Flamme',
            'Die Temperatur, ab der sie kocht',
          ],
          richtig: 1,
        ...
        },
        {
          ...
          antworten: [
            'Diesel brennt heißer als Benzin',
            'Benzin steht draußen immer über seinem Flammpunkt',
            'Diesel brennt ohne Zündquelle gar nicht',
            'Benzin muss man vorher erwärmen',
          ],
          richtig: 1,
        ...
        {
          frage: 'Wind facht ein Feuer an. Was bringt er ihm?',
          antworten: ['Zündenergie', 'Sauerstoff', 'Brennbaren Stoff', 'Wärme'],
          richtig: 1,
