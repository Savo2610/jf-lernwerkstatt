...
const QUIZ = [
  ...
  { kat: 'brennen', wert: 300, f: 'Was ist der Unterschied zwischen Flammpunkt und Brennpunkt?',
    o: ['Es gibt keinen', 'Am Flammpunkt zündet es und geht wieder aus, am Brennpunkt bleibt es',
        'Der Brennpunkt ist kälter', 'Am Brennpunkt braucht es keine Zündquelle'], r: 1,
  ...
  { kat: 'brennen', wert: 400, f: 'Ab welcher Sauerstoffkonzentration erlöschen die meisten Brände?',
    o: ['unter 21 Vol.-%', 'unter 15 bis 17 Vol.-%', 'unter 5 Vol.-%', 'unter 10 Vol.-%'], r: 1,
    e: 'Die meisten Brände erlöschen zwischen 15 und 17 Vol.-%. Genau darauf zielt das Verdünnen.' },
  ...
  { kat: 'klassen', wert: 200, f: 'Welche Brandklasse gibt es gar nicht?',
    o: ['C', 'D', 'E', 'F'], r: 2,
  ...
  { kat: 'klassen', wert: 300, f: 'Ein Kerzenstumpf brennt. Er fühlt sich fest an. Welche Klasse?',
    o: ['A', 'B', 'D', 'F'], r: 1,
    e: 'B. Die Norm sagt „flüssige und flüssig werdende Stoffe" – Wachs wird beim Brennen flüssig.' },
  { kat: 'klassen', wert: 400, f: 'Warum hat Speisefett seit 2005 eine eigene Brandklasse?',
  ...
  { kat: 'verfahren', wert: 200, f: 'Welche drei Spielarten hat das Ersticken?',
  ...
  { kat: 'verfahren', wert: 300, f: 'Welches Löschverfahren nimmt gar keine Voraussetzung weg?',
    o: ['Abkühlen', 'Verdünnen', 'Trennen', 'Hemmen der Reaktion'], r: 3,
  ...
  { kat: 'verfahren', wert: 400, f: 'Wobei fließt Wasser – und es ist trotzdem kein Abkühlen?',
  ...
  { kat: 'mittel', wert: 200, f: 'Was ist die Hauptlöschwirkung von Löschpulver?',
    o: ['Abkühlen', 'Trennen', 'Hemmen der Reaktion', 'Abmagern'], r: 2,
  ...
  { kat: 'mittel', wert: 300, f: 'Warum niemals Wasser in eine brennende Fritteuse?',
    o: ['Das Fett wird hart', 'Wasser leitet Strom',
        'Das Wasser verdampft schlagartig und schleudert brennendes Fett durch den Raum', 'Es passiert gar nichts'], r: 2,
    e: 'Die Fettexplosion. Aus einem Liter Wasser werden 1700 Liter Dampf – und der reißt das brennende Fett mit.' },
  { kat: 'mittel', wert: 400, f: 'Warum ist Kohlendioxid im Freien nutzlos?',
    o: ['Es ist zu kalt', 'Es verweht, bevor es den Sauerstoff verdrängen kann',
        'Es ist nicht zugelassen', 'Es brennt selbst'], r: 1,
  ...
  { f: 'Was brennt bei einer brennenden Flüssigkeit?',
    o: ['Die Flüssigkeit selbst', 'Die Dämpfe darüber', 'Der Behälter', 'Der Sauerstoff'], r: 1,
    e: 'Immer die Dämpfe über der Flüssigkeit. Nie die Flüssigkeit selbst.' },
  { f: 'Ist Wind eine Zündquelle?',
    o: ['Ja', 'Nein – er bringt Sauerstoff, keine Energie', 'Nur bei Sturm', 'Nur im Sommer'], r: 1,
    e: 'Wind facht an, aber er zündet nicht. Eine Zündquelle bringt Energie.' },
  ...
  { f: 'Warum geht ab der Rauchgrenze niemand ohne Atemschutz vor?',
    o: ['Wegen der Sicht', 'Wegen der Hitze', 'Weil bei jedem Brand Atemgifte entstehen', 'Wegen der Vorschrift'], r: 2,
